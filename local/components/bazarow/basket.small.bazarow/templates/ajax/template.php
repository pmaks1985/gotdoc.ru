...
<div class="btn backet d-flex align-items-center">
    ...
    <? if($quant==0):?>
        <a class="text-decoration-none text-white" href="/personal/cart/"> Корзина пуста</a>
    <?else:?>
        <a class="text-decoration-none text-white" href="/personal/cart/"> Корзина <span>(<?=$quant?>)</span></a>
    <?endif;?>
    </span>
</div>