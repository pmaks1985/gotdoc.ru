...
<div>
    <div class="">
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
            ...
            ?>
            <div class="filter">
                <span class="filter-title pl-2"><? echo GetMessage("CT_BCSF_FILTER_TITLE") ?></span>
                <?
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    if (
                        empty($arItem["VALUES"])
                    ...
                    if (
                        ...
                        continue;
                    ?>
                    <div class="filter-block <? if ($arItem["DISPLAY_EXPANDED"] == "Y"): ?>active<? endif ?>">
                        <span class="bx_filter_container_modef d-none"></span>
                        ...
                        ?>
                            <li class="dropright">
                                <a class="dropdown-toggle dropdown-item d-flex align-items-center" href="#"
                                   ...
                                   aria-haspopup="true"
                                   aria-expanded="false">
                                    <div class="text-normal"><?= $arItem["NAME"] ?></div>
                                    <i class="bi bi-chevron-right"></i>
                                </a>
                                <div class="dropdown-menu keep_open"
                                     aria-labelledby="dropdownMenuLink<?= $val; ?>">
                                    <? foreach ($arItem["VALUES"] as $val => $ar): ?>

                                        <div class="custom-control custom-checkbox <? echo $ar["DISABLED"] ? 'disabled' : '' ?>">
