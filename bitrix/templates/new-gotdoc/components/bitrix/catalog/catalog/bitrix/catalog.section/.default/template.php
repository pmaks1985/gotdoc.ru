                ...
                <div class="product-list d-flex">
					<?if(is_array($arElement["PREVIEW_PICTURE"])):?>
                        <div class="product-list_img">
                            <img src="<?=$arElement["PREVIEW_PICTURE"]["SRC"]?>" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" class="product-list_img__src">
                        </div>
					...
					<?if($arPrice["CAN_ACCESS"]):?>
                        <div class="price">
                            ...
                            <div class="buy-button">
                                <a href="<?=$arElement["DETAIL_PAGE_URL"]?>" class="btn-outline-danger text-decoration-none buy-button_link">Заказать</a>
                            </div>
                        </div>
					<?endif;?>
				<?endforeach;?>
