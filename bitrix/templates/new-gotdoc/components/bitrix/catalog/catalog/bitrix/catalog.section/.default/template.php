...
<td valign="top" width="<?= round(100 / $arParams["LINE_ELEMENT_COUNT"]) ?>%"
    ...
    <td valign="top">
        <a href="<?= $arElement["DETAIL_PAGE_URL"] ?>"><img border="0" src="<?= $arElement["PREVIEW_PICTURE"]["SRC"] ?>"
...
<? endif ?>
    ...
    <? else: ?>
        ...
        <? if ($arElement["CAN_BUY"]): ?>
            ...
            <? else: ?>
                <noindex>
                    <a href="<? echo $arElement["BUY_URL"] ?>" rel="nofollow"><? echo GetMessage("CATALOG_BUY") ?></a>&nbsp;<a
