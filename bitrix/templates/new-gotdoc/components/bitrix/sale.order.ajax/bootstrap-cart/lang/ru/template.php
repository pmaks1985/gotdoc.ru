...
$MESS["SOA_ORDER_SUC1"] = "<p>Для завершения заказа необходимо:</p><p class='h4'>1.	Перейти в <a href=\"#LINK#\">Персональный раздел сайта</a>.</p><p>Обратите внимание, что для входа в этот раздел вам необходимо будет ввести <b>логин и пароль</b>, отправленные на e-mail, указанный при оформлении заказа.</p><p class='h4'>2. Заполнить анкету по объекту</p><p>Сразу после заполнения анкеты вам будет доступен просмотр перечня документов, сформированных для вашего комплекта.</p><p class='h4'>3. Оплатить</p><p>Через онлайн-кассу для физических лиц, либо оплатив счет для юридических лиц.</p><p class='h4'>4. Скачать архив с документами</p><p>Файл архива будет доступен для скачивания в <a href=\"#LINK#\">Персональном разделе</a> сразу после поступления денежных средств на счет.</p><p>По завершении каждого этапа на ваш e-mail будет отослано уведомление. В случае, если письма не доходят, проверьте, пожалуйста, папку СПАМ</p>";
...
$MESS["EXPLANATIONS"] = "<p>Тех. поддержка сервиса «Готовые документы»</p><p>Телефон: <a href='tel:+78005504908'>8 (800) 550-49-08</a> (бесплатный звонок по России)</p><p>E-mail: <a href='mailto:info@gotdoc.ru'>info@gotdoc.ru</a></p><p>пн-вс 06:00-21:00 (время московское) </p>"
?>
