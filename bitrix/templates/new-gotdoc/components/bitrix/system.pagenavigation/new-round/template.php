        ...
        <? if ($arResult["bDescPageNumbering"] === true): ?>
            ...
            <? if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]): ?>
                ...
                <? else: ?>
                    ...
                    <? endif ?>
                    <li class="2 list-group-item page-navidation_numbers"><a href="<?= $arResult["sUrlPath"] ?><?= $strNavQueryStringFull ?>"><span>1</span></a>
                    </li>
                <? endif ?>
            <? else: ?>
        ...
        <? else: ?>
            ...
            <? if ($arResult["NavPageNomer"] > 1): ?>
                ...
                <? else: ?>
                    ...
                    <? endif ?>
                    <li class="6 list-group-item page-navidation_numbers"><a href="<?= $arResult["sUrlPath"] ?><?= $strNavQueryStringFull ?>" class="page-navidation_numbers"><span>1</span></a>
                    </li>
                <? endif ?>
            <? else: ?>
                <li class="bx-pag-prev list-group-item page-navidation_numbers"><span><? echo GetMessage("round_nav_back") ?></span></li>
