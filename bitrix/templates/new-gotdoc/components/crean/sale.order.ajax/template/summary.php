...
?>
<div class="bx_ordercart" style="margin-top:20px;">
...
//$basket1 = $basket->getBasketCode();
//print_r($basket['PRODUCT_ID']);
?>
<script>
...
<a href="#" onclick="post_to_url('https://service.gotdoc.ru/api/?class=Market&action=getPrivateId', {'setId':'<?=$arItem["ID"];?>','customerId':'<?=$user;?>','orderId':'1'}, 'POST')">отправить</a>
</td>
