    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="goods-description">
                <div class="d-flex">
                    <a class="btn goods-description_btn" data-toggle="collapse" href="#description1" role="button" aria-expanded="false" aria-controls="description1">Описание</a>
                    <a class="btn goods-description_btn" data-toggle="collapse" href="#description2" role="button" aria-expanded="false" aria-controls="description2">Перечень документов</a>
                    <a class="btn goods-description_btn" data-toggle="collapse" href="#description3" role="button" aria-expanded="false" aria-controls="description3">Как заказать</a>
                    <a class="btn goods-description_btn" data-toggle="collapse" href="#description4" role="button" aria-expanded="false" aria-controls="description4">Вопросы-ответы</a>
                    <a class="btn goods-description_btn" data-toggle="collapse" href="#description5" role="button" aria-expanded="false" aria-controls="description5">Отзывы</a>
                </div>
                            ...
                            <div class="d-flex goods-description_list">
                                <div class="goods-description_list__frame">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe width="410" height="280" src="https://www.youtube.com/embed/Gg0oZWq4Qfg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                ...
                <div class="col-lg-3">
                    <div class="card-interest d-flex flex-column align-items-center">
                        ...
                        <div class="card-interest_button">
                            <a href="#" class="btn-outline-danger text-decoration-none buy-button_link card-interest_button__link">Заказать</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
