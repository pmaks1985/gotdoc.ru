			...
			<form id="btn1f" name="btnf">
				<div class="form-group row pt-4 pb-5 mb-4">
					...
					<div class="col-md-4 text-center pt-4">
						<button type="submit" id="orgbtn" name="orgbtn" class="btn btn-danger myriadbold b24-web-form-popup-btn-12">
							<a data-toggle="modal" class="text-decoration-none" href="">
								<span class="h5 text-white">Оставить заявку</span>
							</a>
						</button>
					</div>
					<div class="col-md-4">
...
<div id="lightbox2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	...
	<div class="container p-4"> 
			<div class="row"> 
			 	<div class="col-lg-7 text-left pr-2"> 
					 <span class="text-dark h1 mullerbold ">У нас есть бонус для вас!</span>

					<div class="row pt-5"> 
			 			<div class="col-md">
							<span class="text-dark h5 myriadreg">Закажите комплект документов и получите бесплатное обучение<br>
																 у нашего партнера Учебного центра «Академия безопасности»<br> 
							<a href="https://ab-dpo.ru" target="_blank">ab-dpo.ru</a></span>
						</div>
					</div>
					<form id="btn5f" name="btnf">
					...
					<div class="row pt-3 pb-5"> 
			 			...
			 			<div class="col-lg-6 text-center">
							<span class="text-danger h5 myriadreg pr-2">Заберите свой бонус</span><img src="/images/rdocrf/Стрелка.png" alt="">
						</div>
					</div>

				</div> 
			 	<div class="col-lg-5 text-left pl-2"> 
					<div class="block8_1">  <img class="block8img" src="/images/rdocrf/Подарок.png"></div>
				</div> 
			</div> 
	</div>
